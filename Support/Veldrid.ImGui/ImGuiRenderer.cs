...
namespace ImGui.Window.Support.Veldrid.ImGui
{
    /// <summary>
    /// Can render draw lists produced by ImGui.
    /// Also provides functions for updating ImGui input.
    /// </summary>
    /// <remarks>Implemented directly to the project, so a hard dependency on Veldrid.ImGui's ImGui.NET can be avoided. ImGui.Window should have the dependency privilege.</remarks>
